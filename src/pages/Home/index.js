...
export default function index() {
  ...
  return (
    <Layout heading={'Homepage'}>
      ...
      <div className="relative flex flex-wrap mt-12 box-border">
        {/* Section Column 1 */}
        <div className="relative flex flex-initial w-2/3 pr-3">
          <div className="grid gap-6 w-full h-fit">
            {/* Unit Currency */}
            <div className="relative grid grid-cols-2 gap-6 h-fit w-full">
              {dummyDataUbis.map((item, index) => (
                <div
                  key={index}
                  className="group relative h-fit bg-white p-4 rounded-lg flex gap-3 hover:bg-blue-500 transition-all duration-300 cursor-pointer">
                  ...
                  <div className="relative text-zinc-800 group-hover:text-white transition-all duration-300">
                    <h1 className="text-2xl font-semibold">
                      ...
                      {/* {' ' +
                    (item.rupiah / 1000000000).toLocaleString('id-ID')} M{' '} */}
                    </h1>
        ...
        {/* Section Column 2 */}
        <div className="relative flex flex-initial w-1/3 pl-3 box-border">
